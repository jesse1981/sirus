...
require_once 'classes/excel/writer/Parser.php';
require_once 'classes/excel/writer/BIFFwriter.php';
    ...
    */
    function _XF(&$format)
    {
        try {
            ...
            // Generally: Notice: Object of class Spreadsheet_Excel_Writer_Format could not be converted to int in /var/www/classes/excel/writer/Worksheet.php on line 1234
        }
    }
    ...
    */
    function writeBlank($row, $col, $format)
    {
        ...
        try {
            ...
            // Generally: Notice: Object of class Spreadsheet_Excel_Writer_Format could not be converted to int in /var/www/classes/excel/writer/Worksheet.php on line 1687
        }
