...
class Spreadsheet_Excel_Writer_Validator_List extends Spreadsheet_Excel_Writer_Validator
{
   function Spreadsheet_Excel_Writer_Validator(&$parser)
   {
   ...
   function setList($source, $incell = true)
   {
      ...
      $this->_formula1 = pack("CCC", 0x17, strlen($source), 0x00) . $source;
      $this->_formula2 = pack("CCC", 0x17, strlen($source), 0x00) . $source;
   }
