...
require_once 'classes/excel/writer/Format.php';
require_once 'classes/excel/writer/BIFFwriter.php';
require_once 'classes/excel/writer/Worksheet.php';
require_once 'classes/excel/writer/Parser.php';
require_once 'classes/excel/ole/PPS/Root.php';
require_once 'classes/excel/ole/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @return &Spreadsheet_Excel_Writer_Validator reference to a Validator
    */
    function &addValidatorList()
    {
	    include_once('Spreadsheet/Excel/Writer/Validator.php');
	    /* FIXME: check for successful inclusion*/
	    $valid = new Spreadsheet_Excel_Writer_Validator_List($this->_parser);
	    return $valid;
    }
