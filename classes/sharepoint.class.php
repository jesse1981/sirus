...
class SharePointAPI {
	 ...
	 */
	public function __construct ($spUsername="", $spPassword="", $spWsdl=SP_WSDL, $mode = 'STANDARD') {
		...
		assert(class_exists('SoapClient'));
                ...
                if ((!$spUsername) && (!$spPassword)) {
                    if (!isset($_SERVER['PHP_AUTH_USER'])) {
                        ...
                        $this->spUsername = $_SERVER['PHP_AUTH_USER'];
                        $this->spPassword = $_SERVER['PHP_AUTH_PW'];
                    }
                }
                else {
