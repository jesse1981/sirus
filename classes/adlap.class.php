...
*/
require_once(dirname(__FILE__) . '/adldap_4.0.1/collections/adLDAPCollection.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPGroups.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPUsers.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPFolders.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPUtils.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPContacts.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPExchange.php');
require_once(dirname(__FILE__) . '/adldap_4.0.1/classes/adLDAPComputers.php');
...
class adLDAP {
    ...
    */
    const ADLDAP_LDAP_PORT = LDAP_PORT;
    /**
    * The default port for LDAPS SSL connections
    */
    const ADLDAP_LDAPS_PORT = LDAP_LDAPS;
    ...
    * @var string
    */   
	protected $accountSuffix = LDAP_SUFFIX;
    ...
    * @var array
    */
#    protected $domainControllers = array("192.168.1.21");
	protected $domainControllers = array(LDAP_DOMAINNAME);
